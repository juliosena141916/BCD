...
CREATE TABLE `os_mecanicos` (
  `id_os_mec` int NOT NULL AUTO_INCREMENT,
  `id_ords_FK` int DEFAULT NULL,
  `id_mec_FK` int DEFAULT NULL,
  PRIMARY KEY (`id_os_mec`),
  KEY `id_ords_FK` (`id_ords_FK`),
  KEY `id_mec_FK` (`id_mec_FK`),
  CONSTRAINT `os_mecanicos_ibfk_1` FOREIGN KEY (`id_ords_FK`) REFERENCES `ordem_servico` (`id_ords`),
  CONSTRAINT `os_mecanicos_ibfk_2` FOREIGN KEY (`id_mec_FK`) REFERENCES `mecanicos` (`id_mec`)
